                            ...
                            switch(opc){
                                case 1:
                                    ...
                                    if(cola.linealSearch(valor)!=-1){
                                        System.out.print("El elemento "+valor+" fue encontrado en la posicion "+cola.linealSearch(valor));
                                    }else{
                                ...
                                case 2:
                                    ...
                                    if(cola.binarySearch(valor)!=-1){
                                        System.out.print("El elemento "+valor+" fue encontrado en la posicion "+cola.binarySearch(valor));
                                    }else{
                                        System.out.print("El elemento "+valor+" no se encuentra en la estructura");
                                    }
                                    System.out.flush();
